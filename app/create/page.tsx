...
export default function CreatorPage() {
  ...
  const handleShareWhatsApp = () => {
    const text = `Your contact ${config.senderName || 'Someone'} sent you a special invitation! ✨ Can you say YES?\n\n${shareUrl}`;
